// import { destination } from '../mock/cities';
import { createElement } from '../render';
import { humanizeDueDate,humanizeDueTime, } from '../util';
const createWayPointTemplate = (event,destinations) => {
  ...
  // const tripTime = tripDuration(dateFrom,dateTo);
...
export default class WayPoint {
  ...
  getTemplate() {
    return createWayPointTemplate(this.event,this.destinations);
  }
